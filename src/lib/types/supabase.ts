  ...
  public: {
    Tables: {
      ...
      bike_assignments: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["courier_id"]
            isOneToOne: false
            referencedRelation: "courier_balances"
      ...
      courier_balance_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "courier_balance_transactions_courier_id_fkey"
            columns: ["courier_id"]
            isOneToOne: false
            referencedRelation: "courier_balances"
            referencedColumns: ["courier_id"]
          ...
          {
            foreignKeyName: "courier_balance_transactions_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "courier_balance_transactions_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      migration_verification: {
        Row: {
          ...
          full_name: string | null
          new_system_balance: number | null
          old_system_net_total: number | null
        }
        Relationships: [
          {
            foreignKeyName: "earnings_periods_courier_id_fkey"
